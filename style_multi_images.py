...
parser.add_argument("--config","-con",
                    help="Path to style multi images config file")
parser.add_argument("--checkpoint","-ckpt",
                    help="Path to trained style checkpoints")
parser.add_argument('--path',"-p",
                    help='path to images folder to style')
parser.add_argument('--image_size',"-size",nargs='+',type=int,default=[256,256], 
                    help='output image size')
parser.add_argument("--output","-out",default="output",
