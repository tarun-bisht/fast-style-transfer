...
from style_transfer.train_utils import (get_loss_model,perceptual_loss,
	gatys_train_step)
import argparse
import numpy as np
...
parser.add_argument('--image',"-img",
					help='url or file path to image to style')
parser.add_argument('--image_size',"-size",nargs='+',type=int,default=[256,256], 
					help='output image size')
parser.add_argument("--output","-out",default="output/optimization_styled.jpg",
...
for epoch in range(1,epochs+1):
	print(f"epoch: {epoch}")
	batch_loss=gatys_train_step(image,content_activations,style_activations,
				steps_per_epoch,loss_model,optimizer,
